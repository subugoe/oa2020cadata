...
require(rJava)
require(writexl)
rmarkdown::render("kb_fetch_publisher_global.Rmd")
```
...
.jinit()
jdbcDriver <-
  JDBC(driverClass = "oracle.jdbc.OracleDriver", classPath = "~/ojdbc8.jar") # you may need to change the path to your db driver
jdbcConnection <-
  dbConnect(
    jdbcDriver,
